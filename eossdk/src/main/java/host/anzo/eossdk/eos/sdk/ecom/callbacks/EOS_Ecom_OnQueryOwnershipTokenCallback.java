...
import host.anzo.eossdk.eos.sdk.ecom.callbackresults.EOS_Ecom_QueryOwnershipTokenCallbackInfo;

/**
 * @author Anton Lasevich
 * @since 8/20/2023
 */
public interface EOS_Ecom_OnQueryOwnershipTokenCallback extends Callback {
	/**
	 ...
	 */
	void apply(EOS_Ecom_QueryOwnershipTokenCallbackInfo data);
}