...
import host.anzo.eossdk.eos.sdk.ecom.callbackresults.EOS_Ecom_QueryEntitlementsCallbackInfo;

/**
 * @author Anton Lasevich
 * @since 8/20/2023
 */
public interface EOS_Ecom_OnQueryEntitlementsCallback extends Callback {
	/**
	 ...
	 */
	void apply(EOS_Ecom_QueryEntitlementsCallbackInfo data);
}