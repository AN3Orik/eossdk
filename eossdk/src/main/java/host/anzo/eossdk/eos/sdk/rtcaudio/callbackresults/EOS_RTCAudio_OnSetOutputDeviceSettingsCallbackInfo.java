...
public class EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo extends Structure {
	/**
	 * This returns:<br>
	...
	public EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo() {
		super();
	}

	public EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo(Pointer peer) {
		super(peer);
	}

	public static class ByReference extends EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo implements Structure.ByReference {
	}

	public static class ByValue extends EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo implements Structure.ByValue {
	}
}