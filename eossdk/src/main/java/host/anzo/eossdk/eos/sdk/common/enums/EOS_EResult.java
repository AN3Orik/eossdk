 ...
 * @since 8/5/2023
 */
public @Getter enum EOS_EResult implements NativeMapped {
	EOS_Success(0),
	...
	private static final Map<Integer, EOS_EResult> values = new HashMap<>();

	static {
		for (EOS_EResult result : values()) {
