...
import host.anzo.eossdk.eos.sdk.sessions.callbackresults.EOS_Sessions_JoinSessionCallbackInfo;

/**
 * @author Anton Lasevich
 * @since 9/7/2023
 */
public interface EOS_Sessions_OnJoinSessionCallback extends Callback {
	/**
	 ...
	 */
	void apply(EOS_Sessions_JoinSessionCallbackInfo data);
}