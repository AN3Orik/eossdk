...
public class EOS_Connect_UnlinkAccountCallbackInfo extends Structure {
	...
	public EOS_Connect_UnlinkAccountCallbackInfo() {
		super();
	}

	public EOS_Connect_UnlinkAccountCallbackInfo(Pointer peer) {
		super(peer);
	}

	public static class ByReference extends EOS_Connect_UnlinkAccountCallbackInfo implements Structure.ByReference {
	}

	public static class ByValue extends EOS_Connect_UnlinkAccountCallbackInfo implements Structure.ByValue {
	}
}