...
dependencies {
    ...
    implementation "host.anzo:eossdk:1.18.1.2.+"
}
```
...
dependencies {
    ...
    implementation "host.anzo:eossdk-native-windows:1.18.1.2"
    // Linux native library
    implementation "host.anzo:eossdk-native-linux:1.18.1.2"
    // iOS native library
    implementation "host.anzo:eossdk-native-ios:1.18.1.2"
}
```
